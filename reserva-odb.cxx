...
namespace odb
{
        ...
        my_bool* t)
  {
    ...
    if (t[1UL])
    {
      i._data_value.capacity (i._data_size);
      grew = true;
    }
        ...
        mysql::statement_kind sk)
  {
    ...
    b[n].buffer = i._data_value.data ();
    b[n].buffer_length = static_cast<unsigned long> (
      i._data_value.capacity ());
    b[n].length = &i._data_size;
    b[n].is_null = &i._data_null;
    n++;
    ...
    b[n].buffer_type = MYSQL_TYPE_LONG;
    b[n].is_unsigned = 0;
    b[n].buffer = &i._num_places_value;
    b[n].is_null = &i._num_places_null;
    n++;

    // _preu_pagat
    //
    b[n].buffer_type = MYSQL_TYPE_FLOAT;
    b[n].buffer = &i._preu_pagat_value;
    b[n].is_null = &i._preu_pagat_null;
    n++;
        ...
        mysql::statement_kind sk)
  {
    ...
    //
    {
      ...
      bool is_null (false);
      std::size_t size (0);
      std::size_t cap (i._data_value.capacity ());
      mysql::value_traits<
          ::std::string,
        ...
        is_null,
        v);
      i._data_null = is_null;
      i._data_size = static_cast<unsigned long> (size);
      grew = grew || (cap != i._data_value.capacity ());
    }
    ...
    //
    {
      ...
      mysql::value_traits<
        ...
        i._num_places_value, is_null, v);
      i._num_places_null = is_null;
    }
    ...
    //
    {
      ...
      mysql::value_traits<
        ...
        i._preu_pagat_value, is_null, v);
      i._preu_pagat_null = is_null;
    }
