...
namespace odb
{
    ...
    query_columns< ::experiencia, id_mysql, typename A::base_traits >
  {
    ...
    static const num_nits_type_ num_nits;
  };
  ...
  template <typename A>
  const typename query_columns< ::escapada, id_mysql, A >::num_nits_type_
  query_columns< ::escapada, id_mysql, A >::
  num_nits (A::table_name, "`num_nits`", 0);
